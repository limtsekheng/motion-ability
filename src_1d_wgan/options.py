...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--img_save_freq', type=int, default=100, help='freq (epoch) of saving images')
    ...
    self.parser.add_argument('--n_ep', type=int, default=800, help='number of epochs') # 400 * d_iter
    self.parser.add_argument('--n_ep_decay', type=int, default=400, help='epoch start decay learning rate, set -1 if no decay') # 200 * d_iter
