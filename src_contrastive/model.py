...
class DRIT(nn.Module):
  ...
  def get_contrastive_loss(self, content_a, content_b, labels_a, labels_b, margin):
    ...
    dist_sim = torch.norm(content_a - content_b, dim=1)/100000
  ...
  def backward_EG(self):
    ...
    loss_contrastive = self.get_contrastive_loss(self.z_content_a, self.z_content_b, self.label_A, self.label_B, margin=2)
